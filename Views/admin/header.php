    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/project/home" class="brand-logo">
                <img class="logo-abbr" src="Publics/admin/images/logo5.png" alt="">
								...
								<ul class="contacts">
									...
									<li class="active dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="Publics/admin/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="Publics/admin/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="Publics/admin/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="Publics/admin/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="Publics/admin/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dlab-scroll" id="dlab_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="Publics/admin/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="Publics/admin/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="Publics/admin/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="<?=getStorageLink($array->image)?>" width="20" alt=""/>
									<div class="header-info">
										<span class="text-black"><?= $array->fullname ?></span>
										<p class="fs-12 mb-0"><?= $array->position?></p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/project/profile&id=<?=$array->id;?>" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/project/logout" class="dropdown-item ai-icon">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="a" href="/project/home" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/project/addmenu">Thêm Món </a></li>
                           
                            <li><a href="/project/menu">Thực Đơn</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/project/addcate">Thêm Danh Mục </a></li>
                           
                            <li><a href="/project/cate"> Danh Sách Danh Mục</a></li>
						
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-user-3"></i>
							<span class="nav-text">Quản Trị Thành Viên</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/project/addEmployee">Thêm Thành Viên</a></li>
                            <li><a href="/project/listEmployee">Danh Sách </a></li>
                            
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-internet"></i>
							<span class="nav-text">Danh Sách Oder</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/project/listOder">Danh Sách</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/project/blogAdmin">Danh Sách Bài Viết</a></li>
							<li><a href="/project/addblog">Thêm Bài Viết</a></li>
				...
				<div class="copyright">
					<p> © 2021 </p>
					<p>Made with <span class="heart"></span> by Min</p>
				</div>
			</div>
        </div>
        <!--**********************************
