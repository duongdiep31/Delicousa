                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="/project/insertEmployee" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="pass">Mật Khẩu <span
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-email" name="fullname" placeholder="Họ và Tên">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-email" name="phone" placeholder="Số Điện Thoại...">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control"  name="home" placeholder="Địa Chỉ.">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <textarea class="form-control" id="description" name="experience" rows="5" placeholder="Kinh Nghiệm Làm Việc...."></textarea>                                                    </div>
                                                </div>
                                                <div class="form-group row">
