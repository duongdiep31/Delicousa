                    ...
                    <div class="card overflow-hidden">
                        <div class="text-center p-3 overlay-box ">
                            <div class="profile-photo">
                                <img src="<?= getStorageLink($array->image); ?>" width="100"  class="img-fluid rounded-circle image-cover" style="height:100px;" alt="">
                            </div>
                            <h3 class="mt-3 mb-1 text-white"><?= $array->fullname; ?></h3>
                            <p class="text-white mb-0"><?= $array->position; ?></p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Địa Chỉ</span> <strong class="text-muted"><?= $array->home; ?></strong></li>
                            <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Ngày Sinh</span> 		<strong class="text-muted"><?= $array->age; ?>	</strong></li>
                        </ul>
                        <div class="card-footer border-0 mt-0">
                            <a href="/project/profile" class="btn btn-primary btn-lg btn-block">Chi tiết</a>
                        </div>
                    </div>
                </div>
					<div class="col-xl-6">
